...
using NomRefTypeAttribut = emps::Attributs<NomTypeAttribut, RefAttribut>;
using NcNomAttribut = emps::Attributs<NcAttribut, NomAttribut>;
using NcNomRefAttribut = emps::Attributs<NcAttribut, NomAttribut, RefAttribut>;
using NcNomTypeAttribut = emps::Attributs<NcNomAttribut, TypeAttribut>;
using NcNomRefTypeAttribut = emps::Attributs<NcNomRefAttribut, TypeAttribut>;
