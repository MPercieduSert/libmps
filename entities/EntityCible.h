...
#define ENUM_IdNcNomTemp(ID1) /*! \brief Positions des attributs */ \
    enum Position:post {Id = mere::Id, Id1 = mere::Id1,  Nc = mere::Nc, Nom = mere::Nom, NbrAtt = mere::NbrAtt,\
    Id ## ID1 = Id1};
 ...
 */
template<entidt IDM , class Id1Att> class IdNcNomEntityTemp :
...
template<entidt IDM , class Id1Att> IdNcNomEntityTemp<IDM,Id1Att>::~IdNcNomEntityTemp() {}

template<entidt IDM > using IdNcNomEntity = IdNcNomEntityTemp<IDM,Id1Attribut>;
#define ENUM_IdNcNom(ID1) ENUM_IdNcNomTemp(ID1)

template<entidt IDM > using IdNullNcNomEntity = IdNcNomEntityTemp<IDM,Id1NullAttribut>;
#define ENUM_IdNullNcNom(ID1) ENUM_IdNcNomTemp(ID1)

template<entidt IDM > using IdNegNcNomEntity = IdNcNomEntityTemp<IDM,Id1NegAttribut>;
#define ENUM_IdNegNcNom(ID1) ENUM_IdNcNomTemp(ID1)

//! \ingroup groupeMacroEntity
//! Macro définissant les positions des attributs pour une clé étrangère, un nom cours, un nom et un type.
#define ENUM_IdNcNomTypeTemp(ID1) /*! \brief Positions des attributs */ \
    enum Position:post {Id = mere::Id, Id1 = mere::Id1,  Nc = mere::Nc, Nom = mere::Nom, Type = mere::Type, NbrAtt = mere::NbrAtt,\
    Id ## ID1 = Id1};

/*! \ingroup groupeBaseEntity
 * \brief Classe de base des entités ayant un attribut clé, nom cours, nom et type.
 */
template<entidt IDM , class Id1Att> class IdNcNomTypeEntityTemp :
...
template<entidt IDM , class Id1Att> IdNcNomTypeEntityTemp<IDM,Id1Att>::~IdNcNomTypeEntityTemp() {}

template<entidt IDM > using IdNcNomTypeEntity = IdNcNomTypeEntityTemp<IDM,Id1Attribut>;
#define ENUM_IdNcNomType(ID1) ENUM_IdNcNomTypeTemp(ID1)

template<entidt IDM > using IdNullNcNomTypeEntity = IdNcNomTypeEntityTemp<IDM,Id1NullAttribut>;
#define ENUM_IdNullNcNomType(ID1) ENUM_IdNcNomTypeTemp(ID1)

template<entidt IDM > using IdNegNcNomTypeEntity = IdNcNomTypeEntityTemp<IDM,Id1NegAttribut>;
...
#define ENUM_IdTypeVersionTemp(ID1) /*! \brief Positions des attributs */ \
    enum Position:post {Id = mere::Id, Id1 = mere::Id1, Type = mere::Type, Version = mere::Version, NbrAtt = mere::NbrAtt, Id ## ID1 = Id1};

/*! \ingroup groupeBaseEntity
 * \brief Classe de base des entités ayant un attribut clé, nom cours, nom et type.
 */
template<entidt IDM , class Id1Att> class IdTypeVersionEntityTemp :
...
template<entidt IDM , class Id1Att> IdTypeVersionEntityTemp<IDM,Id1Att>::~IdTypeVersionEntityTemp() {}

template<entidt IDM > using IdTypeVersionEntity = IdTypeVersionEntityTemp<IDM,Id1Attribut>;
#define ENUM_IdTypeVersion(ID1) ENUM_IdTypeVersionTemp(ID1)

template<entidt IDM > using IdNullTypeVersionEntity = IdTypeVersionEntityTemp<IDM,Id1NullAttribut>;
#define ENUM_IdNullTypeVersion(ID1) ENUM_IdTypeVersionTemp(ID1)

template<entidt IDM > using IdNegTypeVersionEntity = IdTypeVersionEntityTemp<IDM,Id1NegAttribut>;
...
#define ENUM_IdArbreSimpleNcNomTemp(ID1) /*! \brief Positions des attributs */ \
    enum Position:post {Id = mere::Id, Id1 = mere::Id1, Parent = mere::Parent, Nc = mere::Nc, Nom = mere::Nom,\
 ...
 */
template<entidt IDM , class Id1Att> class IdArbreSimpleNcNomEntityTemp :
...
template<entidt IDM , class Id1Att> IdArbreSimpleNcNomEntityTemp<IDM,Id1Att>::~IdArbreSimpleNcNomEntityTemp() {}

template<entidt IDM > using IdArbreSimpleNcNomEntity = IdArbreSimpleNcNomEntityTemp<IDM,Id1Attribut>;
#define ENUM_IdArbreSimpleNcNom(ID1) ENUM_IdArbreSimpleNcNomTemp(ID1)

template<entidt IDM > using IdNullArbreSimpleNcNomEntity = IdArbreSimpleNcNomEntityTemp<IDM,Id1NullAttribut>;
#define ENUM_IdNullArbreSimpleNcNom(ID1) ENUM_IdArbreSimpleNcNomTemp(ID1)

template<entidt IDM > using IdNegArbreSimpleNcNomEntity = IdArbreSimpleNcNomEntityTemp<IDM,Id1NegAttribut>;
...
#define ENUM_IdArbreSimpleIdProgNcNomTemp(ID1) /*! \brief Positions des attributs */ \
    enum Position:post {Id = mere::Id, Id1 = mere::Id1, Parent = mere::Parent, IdProg = mere::IdProg, Nc = mere::Nc,\
 ...
 */
template<entidt IDM , class Id1Att> class IdArbreSimpleIdProgNcNomEntityTemp :
...
template<entidt IDM , class Id1Att> IdArbreSimpleIdProgNcNomEntityTemp<IDM,Id1Att>::~IdArbreSimpleIdProgNcNomEntityTemp() {}

template<entidt IDM > using IdArbreSimpleIdProgNcNomEntity = IdArbreSimpleIdProgNcNomEntityTemp<IDM,Id1Attribut>;
#define ENUM_IdArbreSimpleIdProgNcNom(ID1) ENUM_IdArbreSimpleIdProgNcNomTemp(ID1)

template<entidt IDM > using IdNullArbreSimpleIdProgNcNomEntity = IdArbreSimpleIdProgNcNomEntityTemp<IDM,Id1NullAttribut>;
#define ENUM_IdNullArbreSimpleIdProgNcNom(ID1) ENUM_IdArbreSimpleIdProgNcNomTemp(ID1)

template<entidt IDM > using IdNegArbreSimpleIdProgNcNomEntity = IdArbreSimpleIdProgNcNomEntityTemp<IDM,Id1NegAttribut>;
...
#define ENUM_IdCreationModifNumTemp(ID1) /*! \brief Positions des attributs */ \
    enum Position:post {Id = mere::Id, Id1 = mere::Id1, Creation = mere::Creation, Modification = mere::Modification,\
 ...
 */
template<entidt IDM , class Id1Att> class IdCreationModifNumEntityTemp :
...
template<entidt IDM , class Id1Att> IdCreationModifNumEntityTemp<IDM,Id1Att>::~IdCreationModifNumEntityTemp() {}

template<entidt IDM > using IdCreationModifNumEntity = IdCreationModifNumEntityTemp<IDM,Id1Attribut>;
#define ENUM_IdCreationModifNum(ID1) ENUM_IdCreationModifNumTemp(ID1)

template<entidt IDM > using IdNullCreationModifNumEntity = IdCreationModifNumEntityTemp<IDM,Id1NullAttribut>;
#define ENUM_IdNullCreationModifNum(ID1) ENUM_IdCreationModifNumTemp(ID1)

template<entidt IDM > using IdNegCreationModifNumEntity = IdCreationModifNumEntityTemp<IDM,Id1NegAttribut>;
...
#define ENUM_IdDateTimeTypeValeurTemp(ID1) /*! \brief Positions des attributs */ \
    enum Position:post {Id = mere::Id, Id1 = mere::Id1, DateTime = mere::Datetime, Type = mere::Type,\
    Valeur::mere::Valeur, NbrAtt = mere::NbrAtt, Id ## ID1 = Id1};

/*! \ingroup groupeBaseEntity
 * \brief Classe de base des entités ayant un attribut dateTime et Num.
 */
template<entidt IDM , class DateTimeAtt, class ValeurAtt, class Id1Att> class IdDateTimeTypeValeurEntityTemp
...
template<entidt IDM , class Id1Att, class DateTimeAtt, class ValeurAtt>
IdDateTimeTypeValeurEntityTemp<IDM,Id1Att,DateTimeAtt, ValeurAtt>::~IdDateTimeTypeValeurEntityTemp() {}

template<entidt IDM > using IdDateTimeCurrentTypeValeurDoubleEntity
...
template<entidt IDM > using IdDateTimeCurrentTypeValeurIntEntity
...
template<entidt IDM > using IdDateTimeCurrentTypeValeurVariantEntity
...
template<entidt IDM > using IdDateTimeValideTypeValeurDoubleEntity
...
template<entidt IDM > using IdDateTimeValideTypeValeurIntEntity
...
template<entidt IDM > using IdDateTimeValideTypeValeurVariantEntity
...
template<entidt IDM > using IdNullDateTimeCurrentTypeValeurDoubleEntity
...
template<entidt IDM > using IdNullDateTimeCurrentTypeValeurIntEntity
...
template<entidt IDM > using IdNullDateTimeCurrentTypeValeurVariantEntity
...
template<entidt IDM > using IdNullDateTimeValideTypeValeurDoubleEntity
...
template<entidt IDM > using IdNullDateTimeValideTypeValeurIntEntity
...
template<entidt IDM > using IdNullDateTimeValideTypeValeurVariantEntity
...
template<entidt IDM > using IdNegDateTimeCurrentTypeValeurDoubleEntity
...
template<entidt IDM > using IdNegDateTimeCurrentTypeValeurIntEntity
...
template<entidt IDM > using IdNegDateTimeCurrentTypeValeurVariantEntity
...
template<entidt IDM > using IdNegDateTimeValideTypeValeurDoubleEntity
...
template<entidt IDM > using IdNegDateTimeValideTypeValeurIntEntity
...
template<entidt IDM > using IdNegDateTimeValideTypeValeurVariantEntity
...
#define ENUM_CibleTemp(ID1) /*! \brief Positions des attributs */ \
    enum Position:post {Id = mere::Id, Id1 = mere::Id1, IdCible = mere::IdCible, Cible = mere::Cible, NbrAtt = mere::NbrAtt,\
    Id ## ID1 = Id1};

/*! \ingroup groupeBaseEntity
 * \brief Classe de base des entités ayant un attribut clé étrangère, idCible et Cible.
 */
template<entidt IDM , class Id1Att> class CibleEntityTemp : public EntityIDs<IDM,Id1Att,CibleAttributs> {
public:
    using Id1Trans = typename Id1Att::AttTrans;
...
template<entidt IDM , class Id1Att> CibleEntityTemp<IDM,Id1Att>::~CibleEntityTemp() {}

template<entidt IDM > using CibleEntity = CibleEntityTemp<IDM,Id1Attribut>;
#define ENUM_Cible(ID1) ENUM_CibleTemp(ID1)

template<entidt IDM > using CibleNullEntity = CibleEntityTemp<IDM,Id1NullAttribut>;
#define ENUM_CibleNull(ID1) ENUM_CibleTemp(ID1)

template<entidt IDM > using CibleNegEntity = CibleEntityTemp<IDM,Id1NegAttribut>;
...
#define ENUM_CibleRefTemp(ID1) /*! \brief Positions des attributs */ \
    enum Position:post {Id = mere::Id, Id1 = mere::Id1, IdCible = mere::IdCible, Cible = mere::Cible, Ref = mere::Ref, \
    NbrAtt = mere::NbrAtt, Id ## ID1 = Id1};

/*! \ingroup groupeBaseEntity
 * \brief Classe de base des entités ayant un attribut clé étrangère, idCible, cible et ref.
 */
template<entidt IDM , class Id1Att> class CibleRefEntityTemp : public EntityIDs<IDM,Id1Att,CibleAttributs,RefAttribut> {
public:
    using Id1Trans = typename Id1Att::AttTrans;
...
template<entidt IDM , class Id1Att> CibleRefEntityTemp<IDM,Id1Att>::~CibleRefEntityTemp() {}

template<entidt IDM > using CibleRefEntity = CibleRefEntityTemp<IDM,Id1Attribut>;
#define ENUM_CibleRef(ID1) ENUM_CibleRefTemp(ID1)

template<entidt IDM > using CibleNullRefEntity = CibleRefEntityTemp<IDM,Id1NullAttribut>;
#define ENUM_CibleNullRef(ID1) ENUM_CibleRefTemp(ID1)

template<entidt IDM > using CibleNegRefEntity = CibleRefEntityTemp<IDM,Id1NegAttribut>;
...
#define ENUM_CibleNumTypeTemp(ID1) /*! \brief Positions des attributs */ \
    enum Position:post {Id = mere::Id, Id1 = mere::Id1, IdCible = mere::IdCible, Cible = mere::Cible, Num = mere::Num,\
 ...
 */
template<entidt IDM , class Id1Att> class CibleNumTypeEntityTemp :
...
template<entidt IDM , class Id1Att> CibleNumTypeEntityTemp<IDM,Id1Att>::~CibleNumTypeEntityTemp() {}

template<entidt IDM > using CibleNumTypeEntity = CibleNumTypeEntityTemp<IDM,Id1Attribut>;
#define ENUM_CibleNumType(ID1) ENUM_CibleNumTypeTemp(ID1)

template<entidt IDM > using CibleNullNumTypeEntity = CibleNumTypeEntityTemp<IDM,Id1NullAttribut>;
#define ENUM_CibleNullNumType(ID1) ENUM_CibleNumTypeTemp(ID1)

template<entidt IDM > using CibleNegNumTypeEntity = CibleNumTypeEntityTemp<IDM,Id1NegAttribut>;
...
#define ENUM_CibleNumValeurTemp(ID1) /*! \brief Positions des attributs */ \
    enum Position:post {Id = mere::Id, Id1 = mere::Id1, IdCible = mere::IdCible, Cible = mere::Cible,\
 ...
 */
template<entidt IDM , class ValeurAtt, class Id1Att> class CibleNumValeurEntityTemp :
...
template<entidt IDM , class ValeurAtt, class Id1Att>
    CibleNumValeurEntityTemp<IDM,ValeurAtt, Id1Att>::~CibleNumValeurEntityTemp() {}

template<entidt IDM > using CibleNumValeurDoubleEntity
...
template<entidt IDM > using CibleNullNumValeurDoubleEntity
...
template<entidt IDM > using CibleNullNumValeurIntEntity
...
template<entidt IDM > using CibleNullNumValeurVariantEntity
...
template<entidt IDM > using CibleNegNumValeurDoubleEntity
...
template<entidt IDM > using CibleNegNumValeurIntEntity
...
template<entidt IDM > using CibleNegNumValeurVariantEntity
 ...
 */
template<entidt IDM , class DateTimeAtt, class Id1Att> class CibleDateTimeEntityTemp :
...
template<entidt IDM , class DateTimeAtt, class Id1Att> CibleDateTimeEntityTemp<IDM,DateTimeAtt, Id1Att>
    ::~CibleDateTimeEntityTemp() {}

template<entidt IDM > using CibleDateTimeCurrentEntity = CibleDateTimeEntityTemp<IDM,DateTimeCurrentAttribut,Id1Attribut>;
#define ENUM_CibleDateTimeCurrent(ID1) ENUM_CibleDateTimeTemp(ID1)

template<entidt IDM > using CibleDateTimeValideEntity = CibleDateTimeEntityTemp<IDM,DateTimeValideAttribut,Id1Attribut>;
#define ENUM_CibleDateTimeValide(ID1) ENUM_CibleDateTimeTemp(ID1)

template<entidt IDM > using CibleNullDateTimeCurrentEntity = CibleDateTimeEntityTemp<IDM,DateTimeCurrentAttribut,Id1NullAttribut>;
#define ENUM_CibleNullDateTimeCurrent(ID1) ENUM_CibleDateTimeTemp(ID1)

template<entidt IDM > using CibleNullDateTimeValideEntity = CibleDateTimeEntityTemp<IDM,DateTimeValideAttribut,Id1NullAttribut>;
#define ENUM_CibleNullDateTimeValide(ID1) ENUM_CibleDateTimeTemp(ID1)

template<entidt IDM > using CibleNegDateTimeCurrentEntity = CibleDateTimeEntityTemp<IDM,DateTimeCurrentAttribut,Id1NegAttribut>;
#define ENUM_CibleNegDateTimeCurrent(ID1) ENUM_CibleDateTimeTemp(ID1)

template<entidt IDM > using CibleNegDateTimeValideEntity = CibleDateTimeEntityTemp<IDM,DateTimeValideAttribut,Id1NegAttribut>;
 ...
 */
template<entidt IDM , class DateTimeAtt, class Id1Att> class CibleDateTimeNumEntityTemp :
...
template<entidt IDM , class DateTimeAtt, class Id1Att> CibleDateTimeNumEntityTemp<IDM,DateTimeAtt, Id1Att>::~CibleDateTimeNumEntityTemp() {}

template<entidt IDM > using CibleDateTimeCurrentNumEntity = CibleDateTimeNumEntityTemp<IDM,DateTimeCurrentAttribut,Id1Attribut>;
#define ENUM_CibleDateTimeCurrentNum(ID1) ENUM_CibleDateTimeNumTemp(ID1)

template<entidt IDM > using CibleDateTimeValideNumEntity = CibleDateTimeNumEntityTemp<IDM,DateTimeValideAttribut,Id1Attribut>;
#define ENUM_CibleDateTimeValideNum(ID1) ENUM_CibleDateTimeNumTemp(ID1)

template<entidt IDM > using CibleNullDateTimeCurrentNumEntity = CibleDateTimeNumEntityTemp<IDM,DateTimeCurrentAttribut,Id1NullAttribut>;
#define ENUM_CibleNullDateTimeCurrentNum(ID1) ENUM_CibleDateTimeNumTemp(ID1)

template<entidt IDM > using CibleNullDateTimeValideNumEntity = CibleDateTimeNumEntityTemp<IDM,DateTimeValideAttribut,Id1NullAttribut>;
#define ENUM_CibleNullDateTimeValideNum(ID1) ENUM_CibleDateTimeNumTemp(ID1)

template<entidt IDM > using CibleNegDateTimeCurrentNumEntity = CibleDateTimeNumEntityTemp<IDM,DateTimeCurrentAttribut,Id1NegAttribut>;
#define ENUM_CibleNegDateTimeCurrentNum(ID1) ENUM_CibleDateTimeNumTemp(ID1)

template<entidt IDM > using CibleNegDateTimeValideNumEntity = CibleDateTimeNumEntityTemp<IDM,DateTimeValideAttribut,Id1NegAttribut>;
 ...
 * \brief Classe de base des entités ayant un attribut clé étrangère, idCible, Cible, DateTime et Num.
 */
template<entidt IDM , class DateTimeAtt, class Id1Att> class CibleDateTimeNumTypeEntityTemp :
...
template<entidt IDM , class DateTimeAtt, class Id1Att> CibleDateTimeNumTypeEntityTemp<IDM,DateTimeAtt, Id1Att>
    ::~CibleDateTimeNumTypeEntityTemp() {}

template<entidt IDM > using CibleDateTimeCurrentNumTypeEntity = CibleDateTimeNumTypeEntityTemp<IDM,DateTimeCurrentAttribut,Id1Attribut>;
#define ENUM_CibleDateTimeCurrentNumType(ID1) ENUM_CibleDateTimeNumTypeTemp(ID1)

template<entidt IDM > using CibleDateTimeValideNumTypeEntity = CibleDateTimeNumTypeEntityTemp<IDM,DateTimeValideAttribut,Id1Attribut>;
#define ENUM_CibleDateTimeValideNumType(ID1) ENUM_CibleDateTimeNumTypeTemp(ID1)

template<entidt IDM > using CibleNullDateTimeCurrentNumTypeEntity = CibleDateTimeNumTypeEntityTemp<IDM,DateTimeCurrentAttribut,Id1NullAttribut>;
#define ENUM_CibleNullDateTimeCurrentTypeNum(ID1) ENUM_CibleDateTimeNumTypeTemp(ID1)

template<entidt IDM > using CibleNullDateTimeValideNumTypeEntity = CibleDateTimeNumTypeEntityTemp<IDM,DateTimeValideAttribut,Id1NullAttribut>;
#define ENUM_CibleNullDateTimeValideNumType(ID1) ENUM_CibleDateTimeNumTypeTemp(ID1)

template<entidt IDM > using CibleNegDateTimeCurrentNumTypeEntity = CibleDateTimeNumTypeEntityTemp<IDM,DateTimeCurrentAttribut,Id1NegAttribut>;
#define ENUM_CibleNegDateTimeCurrentTypeNum(ID1) ENUM_CibleDateTimeNumTypeTemp(ID1)

template<entidt IDM > using CibleNegDateTimeValideNumTypeEntity = CibleDateTimeNumTypeEntityTemp<IDM,DateTimeValideAttribut,Id1NegAttribut>;
 ...
 */
template<entidt IDM , class DateTimeAtt, class ValeurAtt, class Id1Att> class CibleDateTimeNumValeurEntityTemp :
...
template<entidt IDM , class DateTimeAtt, class ValeurAtt, class Id1Att>
    CibleDateTimeNumValeurEntityTemp<IDM,DateTimeAtt, ValeurAtt, Id1Att>::~CibleDateTimeNumValeurEntityTemp() {}

template<entidt IDM > using CibleDateTimeCurrentNumValeurDoubleEntity
...
template<entidt IDM > using CibleDateTimeCurrentNumValeurIntEntity
...
template<entidt IDM > using CibleDateTimeCurrentNumValeurVariantEntity
...
template<entidt IDM > using CibleDateTimeValideNumValeurDoubleEntity
...
template<entidt IDM > using CibleDateTimeValideNumValeurIntEntity
...
template<entidt IDM > using CibleDateTimeValideNumValeurVariantEntity
...
template<entidt IDM > using CibleNullDateTimeCurrentNumValeurDoubleEntity
...
template<entidt IDM > using CibleNullDateTimeCurrentNumValeurIntEntity
...
template<entidt IDM > using CibleNullDateTimeCurrentNumValeurVariantEntity
...
template<entidt IDM > using CibleNullDateTimeValideNumValeurDoubleEntity
...
template<entidt IDM > using CibleNullDateTimeValideNumValeurIntEntity
...
template<entidt IDM > using CibleNullDateTimeValideNumValeurVariantEntity
...
template<entidt IDM > using CibleNegDateTimeCurrentNumValeurDoubleEntity
...
template<entidt IDM > using CibleNegDateTimeCurrentNumValeurIntEntity
...
template<entidt IDM > using CibleNegDateTimeCurrentNumValeurVariantEntity
...
template<entidt IDM > using CibleNegDateTimeValideNumValeurDoubleEntity
...
template<entidt IDM > using CibleNegDateTimeValideNumValeurIntEntity
...
template<entidt IDM > using CibleNegDateTimeValideNumValeurVariantEntity
 ...
 */
template<entidt IDM , class DateTimeAtt, class ValeurAtt, class Id1Att> class CibleDateTimeNumTpValValeurEntityTemp :
...
template<entidt IDM > using CibleDateTimeCurrentNumTpValValeurDoubleEntity
...
template<entidt IDM > using CibleDateTimeCurrentNumTpValValeurIntEntity
...
template<entidt IDM > using CibleDateTimeCurrentNumTpValValeurVariantEntity
...
template<entidt IDM > using CibleDateTimeValideNumTpValValeurDoubleEntity
...
template<entidt IDM > using CibleDateTimeValideNumTpValValeurIntEntity
...
template<entidt IDM > using CibleDateTimeValideNumTpValValeurVariantEntity
...
template<entidt IDM > using CibleNullDateTimeCurrentNumTpValValeurDoubleEntity
...
template<entidt IDM > using CibleNullDateTimeCurrentNumTpValValeurIntEntity
...
template<entidt IDM > using CibleNullDateTimeCurrentNumTpValValeurVariantEntity
...
template<entidt IDM > using CibleNullDateTimeValideNumTpValValeurDoubleEntity
...
template<entidt IDM > using CibleNullDateTimeValideNumTpValValeurIntEntity
...
template<entidt IDM > using CibleNullDateTimeValideNumTpValValeurVariantEntity
...
template<entidt IDM > using CibleNegDateTimeCurrentNumTpValValeurDoubleEntity
...
template<entidt IDM > using CibleNegDateTimeCurrentNumTpValValeurIntEntity
...
template<entidt IDM > using CibleNegDateTimeCurrentNumTpValValeurVariantEntity
...
template<entidt IDM > using CibleNegDateTimeValideNumTpValValeurDoubleEntity
...
template<entidt IDM > using CibleNegDateTimeValideNumTpValValeurIntEntity
...
template<entidt IDM > using CibleNegDateTimeValideNumTpValValeurVariantEntity
...
#define ENUM_IdNumValeurTemp(ID1) /*! \brief Positions des attributs */ \
    enum Position:post {Id = mere::Id, Id1 = mere::Id1, Num = mere::Num, Valeur = mere::Valeur, NbrAtt = mere::NbrAtt, Id ## ID1 = Id1};

/*! \ingroup groupeBaseEntity
 * \brief Classe de base des entités ayant un attribut clé, num et valeur.
 */
template<entidt IDM , class ValeurAtt, class Id1Att> class IdNumValeurEntityTemp :
...
template<entidt IDM , class ValeurAtt, class Id1Att> IdNumValeurEntityTemp<IDM,ValeurAtt, Id1Att>
    ::~IdNumValeurEntityTemp() {}

template<entidt IDM > using IdNumValeurDoubleEntity = IdNumValeurEntityTemp<IDM,ValeurDoubleAttribut,Id1Attribut>;
#define ENUM_IdNumValeurDouble(ID1) ENUM_IdNumValeurTemp(ID1)

template<entidt IDM > using IdNumValeurIntEntity = IdNumValeurEntityTemp<IDM,ValeurIntAttribut,Id1Attribut>;
#define ENUM_IdNumValeurInt(ID1) ENUM_IdNumValeurTemp(ID1)

template<entidt IDM > using IdNumValeurVariantEntity = IdNumValeurEntityTemp<IDM,ValeurVariantAttribut,Id1Attribut>;
#define ENUM_IdNumValeurVariant(ID1) ENUM_IdNumValeurTemp(ID1)

template<entidt IDM > using IdNullNumValeurDoubleEntity = IdNumValeurEntityTemp<IDM,ValeurDoubleAttribut,Id1NullAttribut>;
#define ENUM_IdNullNumValeurDouble(ID1) ENUM_IdNumValeurTemp(ID1)

template<entidt IDM > using IdNullNumValeurIntEntity = IdNumValeurEntityTemp<IDM,ValeurIntAttribut,Id1NullAttribut>;
#define ENUM_IdNullNumValeurInt(ID1) ENUM_IdNumValeurTemp(ID1)

template<entidt IDM > using IdNullNumValeurVariantEntity = IdNumValeurEntityTemp<IDM,ValeurVariantAttribut,Id1NullAttribut>;
#define ENUM_IdNullNumValeurVariant(ID1) ENUM_IdNumValeurTemp(ID1)

template<entidt IDM > using IdNegNumValeurDoubleEntity = IdNumValeurEntityTemp<IDM,ValeurDoubleAttribut,Id1NegAttribut>;
#define ENUM_IdNegNumValeurDouble(ID1) ENUM_IdNumValeurTemp(ID1)

template<entidt IDM > using IdNegNumValeurIntEntity = IdNumValeurEntityTemp<IDM,ValeurIntAttribut,Id1NegAttribut>;
#define ENUM_IdNegNumValeurInt(ID1) ENUM_IdNumValeurTemp(ID1)

template<entidt IDM > using IdNegNumValeurVariantEntity = IdNumValeurEntityTemp<IDM,ValeurVariantAttribut,Id1NegAttribut>;
...
enum Position:post {Id = mere::Id, Id1 = mere::Id1, Type = mere::Type, Valeur = mere::Valeur, NbrAtt = mere::NbrAtt, Id ## ID1 = Id1};

/*! \ingroup groupeBaseEntity
 * \brief Classe de base des entités ayant un attribut clé, type et valeur.
 */
template<entidt IDM , class ValeurAtt, class Id1Att> class IdTypeValeurEntityTemp :
...
template<entidt IDM , class ValeurAtt, class Id1Att> IdTypeValeurEntityTemp<IDM,ValeurAtt, Id1Att>
    ::~IdTypeValeurEntityTemp() {}

template<entidt IDM > using IdTypeValeurDoubleEntity = IdTypeValeurEntityTemp<IDM,ValeurDoubleAttribut,Id1Attribut>;
#define ENUM_IdTypeValeurDouble(ID1) ENUM_IdTypeValeurTemp(ID1)

template<entidt IDM > using IdTypeValeurIntEntity = IdTypeValeurEntityTemp<IDM,ValeurIntAttribut,Id1Attribut>;
#define ENUM_IdTypeValeurInt(ID1) ENUM_IdTypeValeurTemp(ID1)

template<entidt IDM > using IdTypeValeurVariantEntity = IdTypeValeurEntityTemp<IDM,ValeurVariantAttribut,Id1Attribut>;
#define ENUM_IdTypeValeurVariant(ID1) ENUM_IdTypeValeurTemp(ID1)

template<entidt IDM > using IdNullTypeValeurDoubleEntity = IdTypeValeurEntityTemp<IDM,ValeurDoubleAttribut,Id1NullAttribut>;
#define ENUM_IdNullTypeValeurDouble(ID1) ENUM_IdTypeValeurTemp(ID1)

template<entidt IDM > using IdNullTypeValeurIntEntity = IdTypeValeurEntityTemp<IDM,ValeurIntAttribut,Id1NullAttribut>;
#define ENUM_IdNullTypeValeurInt(ID1) ENUM_IdTypeValeurTemp(ID1)

template<entidt IDM > using IdNullTypeValeurVariantEntity = IdTypeValeurEntityTemp<IDM,ValeurVariantAttribut,Id1NullAttribut>;
#define ENUM_IdNullTypeValeurVariant(ID1) ENUM_IdTypeValeurTemp(ID1)

template<entidt IDM > using IdNegTypeValeurDoubleEntity = IdTypeValeurEntityTemp<IDM,ValeurDoubleAttribut,Id1NegAttribut>;
#define ENUM_IdNegTypeValeurDouble(ID1) ENUM_IdTypeValeurTemp(ID1)

template<entidt IDM > using IdNegTypeValeurIntEntity = IdTypeValeurEntityTemp<IDM,ValeurIntAttribut,Id1NegAttribut>;
#define ENUM_IdNegTypeValeurInt(ID1) ENUM_IdTypeValeurTemp(ID1)

template<entidt IDM > using IdNegTypeValeurVariantEntity = IdTypeValeurEntityTemp<IDM,ValeurVariantAttribut,Id1NegAttribut>;
 ...
 */
template<entidt IDM , class ValeurAtt, class Id1Att> class IdNumTypeVersionValeurEntityTemp :
...
template<entidt IDM , class ValeurAtt, class Id1Att> IdNumTypeVersionValeurEntityTemp<IDM,ValeurAtt, Id1Att>
    ::~IdNumTypeVersionValeurEntityTemp() {}

template<entidt IDM > using IdNumTypeVersionValeurDoubleEntity = IdNumTypeVersionValeurEntityTemp<IDM,ValeurDoubleAttribut,Id1Attribut>;
#define ENUM_IdNumTypeVersionValeurDouble(ID1) ENUM_IdNumTypeVersionValeurTemp(ID1)

template<entidt IDM > using IdNumTypeVersionValeurIntEntity = IdNumTypeVersionValeurEntityTemp<IDM,ValeurIntAttribut,Id1Attribut>;
#define ENUM_IdNumTypeVersionValeurInt(ID1) ENUM_IdNumTypeVersionValeurTemp(ID1)

template<entidt IDM > using IdNumTypeVersionValeurVariantEntity
...
template<entidt IDM > using IdNullNumTypeVersionValeurDoubleEntity
...
template<entidt IDM > using IdNullNumTypeVersionValeurIntEntity = IdNumTypeVersionValeurEntityTemp<IDM,ValeurIntAttribut,Id1NullAttribut>;
#define ENUM_IdNullNumTypeVersionValeurInt(ID1) ENUM_IdNumTypeVersionValeurTemp(ID1)

template<entidt IDM > using IdNullNumTypeVersionValeurVariantEntity
...
template<entidt IDM > using IdNegNumTypeVersionValeurDoubleEntity
...
template<entidt IDM > using IdNegNumTypeVersionValeurIntEntity = IdNumTypeVersionValeurEntityTemp<IDM,ValeurIntAttribut,Id1NegAttribut>;
#define ENUM_IdNegNumTypeVersionValeurInt(ID1) ENUM_IdNumTypeVersionValeurTemp(ID1)

template<entidt IDM > using IdNegNumTypeVersionValeurVariantEntity
...
enum Position:post {Id = mere::Id, Id1 = mere::Id1, Cible = mere::Cible, Code = mere::Code, NbrAtt = mere::NbrAtt, Id ## ID1 = Id1};

/*! \ingroup groupeBaseEntity
 * \brief Classe de base des entités ayant un attribut clé étrangère, idCible et Cible.
 */
template<entidt IDM , class Id1Att> class IdCibleCodeEntityTemp : public EntityIDs<IDM,Id1Att,CibleAttribut,CodeAttribut> {
public:
    using Id1Trans = typename Id1Att::AttTrans;
...
template<entidt IDM , class Id1Att> IdCibleCodeEntityTemp<IDM,Id1Att>::~IdCibleCodeEntityTemp() {}

template<entidt IDM > using IdCibleCodeEntity = IdCibleCodeEntityTemp<IDM,Id1Attribut>;
#define ENUM_IdCibleCode(ID1) ENUM_IdCibleCodeTemp(ID1)

template<entidt IDM > using IdNullCibleCodeEntity = IdCibleCodeEntityTemp<IDM,Id1NullAttribut>;
#define ENUM_IdNullCibleCode(ID1) ENUM_IdCibleCodeTemp(ID1)

template<entidt IDM > using IdNegCibleCodeEntity = IdCibleCodeEntityTemp<IDM,Id1NegAttribut>;
...
enum Position:post {Id = mere::Id, Id1 = mere::Id1, Cible = mere::Cible, Code = mere::Code, Ref = mere::Ref, \
    NbrAtt = mere::NbrAtt, Id ## ID1 = Id1};

/*! \ingroup groupeBaseEntity
 * \brief Classe de base des entités ayant un attribut clé étrangère, idCible et Cible.
 */
template<entidt IDM , class Id1Att> class IdCibleCodeRefEntityTemp : public EntityIDs<IDM,Id1Att,CibleAttribut,CodeAttribut,RefAttribut> {
public:
    using Id1Trans = typename Id1Att::AttTrans;
...
template<entidt IDM , class Id1Att> IdCibleCodeRefEntityTemp<IDM,Id1Att>::~IdCibleCodeRefEntityTemp() {}

template<entidt IDM > using IdCibleCodeRefEntity = IdCibleCodeRefEntityTemp<IDM,Id1Attribut>;
#define ENUM_IdCibleCodeRef(ID1) ENUM_IdCibleCodeRefTemp(ID1)

template<entidt IDM > using IdNullCibleCodeRefEntity = IdCibleCodeRefEntityTemp<IDM,Id1NullAttribut>;
#define ENUM_IdNullCibleCodeRef(ID1) ENUM_IdCibleCodeRefTemp(ID1)

template<entidt IDM > using IdNegCibleCodeRefEntity = IdCibleCodeRefEntityTemp<IDM,Id1NegAttribut>;
...
#define ENUM_IdCibleNumTemp(ID1) /*! \brief Positions des attributs */ \
    enum Position:post {Id = mere::Id, Id1 = mere::Id1, Cible = mere::Cible, Num = mere::Num, NbrAtt = mere::NbrAtt, Id ## ID1 = Id1};

/*! \ingroup groupeBaseEntity
 * \brief Classe de base des entités ayant un attribut clé étrangère, idCible et Cible.
 */
template<entidt IDM , class Id1Att> class IdCibleNumEntityTemp : public EntityIDs<IDM,Id1Att,CibleAttribut,NumAttribut> {
public:
    using Id1Trans = typename Id1Att::AttTrans;
...
template<entidt IDM , class Id1Att> IdCibleNumEntityTemp<IDM,Id1Att>::~IdCibleNumEntityTemp() {}

template<entidt IDM > using IdCibleNumEntity = IdCibleNumEntityTemp<IDM,Id1Attribut>;
#define ENUM_IdCibleNum(ID1) ENUM_IdCibleNumTemp(ID1)

template<entidt IDM > using IdNullCibleNumEntity = IdCibleNumEntityTemp<IDM,Id1NullAttribut>;
#define ENUM_IdNullCibleNum(ID1) ENUM_IdCibleNumTemp(ID1)

template<entidt IDM > using IdNegCibleNumEntity = IdCibleNumEntityTemp<IDM,Id1NegAttribut>;
...
// */
//template<entidt IDM > class CibleSimpleCodeEntity : public EntityIDs<IDM,IdCibleAttribut,CibleAttribut,CodeAttribut> {
//public:
...
//template<entidt IDM > CibleSimpleCodeEntity<IDM>::~CibleSimpleCodeEntity() {}

///*! \ingroup groupeBaseEntity
// * \brief Classe de base des entités ayant un attribut idCible, cible et num.
// */
//template<entidt IDM > class CibleSimpleNumEntity : public EntityIDs<IDM,IdCibleAttribut,CibleAttribut,NumAttribut> {
//public:
...
//template<entidt IDM > CibleSimpleNumEntity<IDM>::~CibleSimpleNumEntity() {}

/*! \ingroup groupeBaseEntity
 * \brief Classe de base des entités ayant un attribut idCible, idEtat, cible, etat, num et dateTime.
 */
template<entidt IDM > class HistoriqueEntity :
...
template<entidt IDM > HistoriqueEntity<IDM>::~HistoriqueEntity() {}

/*! \ingroup groupeBaseEntity
 * \brief Classe de base des entités ayant un attribut IdCible, cible, type et valeur.
 */
template<entidt IDM , class ValeurAtt> class CibleSimpleTypeValeurEntityTemp :
...
template<entidt IDM , class ValeurAtt> CibleSimpleTypeValeurEntityTemp<IDM, ValeurAtt>::~CibleSimpleTypeValeurEntityTemp() {}

template<entidt IDM > using CibleSimpleTypeValeurDoubleEntity = CibleSimpleTypeValeurEntityTemp<IDM,ValeurDoubleAttribut>;
template<entidt IDM > using CibleSimpleTypeValeurIntEntity = CibleSimpleTypeValeurEntityTemp<IDM,ValeurIntAttribut>;
template<entidt IDM > using CibleSimpleTypeValeurVariantEntity = CibleSimpleTypeValeurEntityTemp<IDM,ValeurVariantAttribut>;


/*! \ingroup groupeBaseEntity
 * \brief Classe de base des entités ayant un attribut IdCible, cible, datetime, num, type et valeur.
 */
template<entidt IDM , class DateTimeAtt, class ValeurAtt> class CibleSimpleDateTimeNumTypeValeurEntityTemp :
...
#define ENUM_UtilisationTemp(ID1) /*! \brief Positions des attributs */ \
    enum Position:post {Id = mere::Id, Id1 = mere::Id1, IdCible = mere::IdCible, IdEtat = mere::IdEtat, Cible = mere::Cible,\
 ...
 */
template<entidt IDM , class Id1Att> class UtilisationEntityTemp :
...
template<entidt IDM , class Id1Att> UtilisationEntityTemp<IDM,Id1Att>::~UtilisationEntityTemp() {}

template<entidt IDM > using UtilisationEntity = UtilisationEntityTemp<IDM,Id1Attribut>;
#define ENUM_Utilisation(ID1) ENUM_UtilisationTemp(ID1)

template<entidt IDM > using UtilisationNullEntity = UtilisationEntityTemp<IDM,Id1NullAttribut>;
#define ENUM_UtilisationNull(ID1) ENUM_UtilisationTemp(ID1)

template<entidt IDM > using UtilisationNegEntity = UtilisationEntityTemp<IDM,Id1NegAttribut>;
