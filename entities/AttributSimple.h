...
SINGLE_ATTRIBUT(CouleurBordureAttribut,AttributCouleur,CouleurBordure,couleurBordure)
...
SINGLE_ATTRIBUT_ID(Id1ZeroAttribut,AttributId,1)
...
SINGLE_ATTRIBUT(TotalAttribut,AttributIntSup<1>,Total,total)
SINGLE_ATTRIBUT(TpValAttribut,AttributInt,TpVal,tpVal)
SINGLE_ATTRIBUT(TypeAttribut,AttributIdSup<1>,Type,type)
SINGLE_ATTRIBUT(TypeIdtAttribut,AttributId,Type,type)
