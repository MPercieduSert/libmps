 ...
 */
#define DEL_LIST {typename ListPtr<Ent>::iterator i = liste.begin(); \
 ...
 */
#define DEF_DEL_METHODE(CLASS) template<class Ent> bool CLASS::delList(const ListPtr<Ent> & liste) DEL_LIST \
...
public:
    ...
    Bdd(const QString & dbtype, int version, Managers * manager = nullptr)
    ...
    Bdd(const QString & dbtype, const QString & fileName, int version, Managers * manager = nullptr)
    ...
    //! Renvoie la liste des entités de la table des entités Ent vérifiant la condition,
    //! valeur de la colonne d'identifiant cle = value, ordonnée suivant la colonne d'identifiant ordre.
    template<class Ent> ListPtr<Ent> getList(typename Ent::Position cle, const QVariant & value, typename Ent::Position ordre = Ent::Id,
                                             bdd::Condition cond = bdd::Condition::Egal, bool crois = true);

    //! Renvoie la liste des entités de la table des entités Ent vérifiant la condition,
    //! valeur de la colonne d'identifiant cle = value, ordonnée suivant les colonnes d'identifiant ordre1 puis ordre2.
    template<class Ent> ListPtr<Ent> getList(typename Ent::Position cle, const QVariant & value,
                                             typename Ent::Position order1, typename Ent::Position order2,
                                             bdd::Condition cond = bdd::Condition::Egal, bool croissant1 = true, bool croissant2 = true);
    ...
    template<class Ent> ListPtr<Ent> getList(const QList<typename Ent::Position> & cle, const QList<QVariant> & value,
                         const QList<typename Ent::Position> & ordre = QList<typename Ent::Position>(),
                         const QList<bdd::Condition> & condition = QList<bdd::Condition>(), const QList<bool> & crois = QList<bool>());
    ...
    template<class Ent, class Join> ListPtr<Ent> getList(typename Join::Position cleJoin, typename Join::Position cleWhere,
    ...
    //! valeur de la colonne d'identifiant cle = value.
    template<class Ent> MapPtr<Ent> getMap(typename Ent::Position cle, const QVariant & value,
    ...
    //! valeur de la colonne d'identifiant cle[i] condition[i] value[i],
    //! ordonnée suivant les colonnes d'identifiant contenue dans ordre, croissante (crois[i]=true) ou décroissante (croiss[i]=false).
    template<class Ent> MapPtr<Ent> getMap(QList<typename Ent::Position> cle, QList<const QVariant> & value,
                         typename Ent::Position cleMap = Ent::Id,
                         QList<typename Ent::Position> ordre = QList<typename Ent::Position>(),
                         QList<bdd::Condition> condition = QList<bdd::Condition>(), QList<bool> crois = QList<bool>());
    ...
    //! Renvoie la liste des entités de la table vérifiant une condition sur une jointure (Ent.ID = Join.cleJoin),
    //! valeur de la colonne de la jointure d'identifiant cleWhere = valueWhere.
    template<class Ent, class Join> MapPtr<Ent> getMap(typename Join::Position cleJoin, typename Join::Position cleWhere,
    ...
    //! valeur de la colonne d'identifiant cle = value, ordonnée suivant la colonne d'identifiant ordre.
    template<class Ent> VectorPtr<Ent> getVector(typename Ent::Position cle, int value, typename Ent::Position ordre = Ent::Id,
                                                 bdd::Condition cond = bdd::Condition::Egal, bool crois = true);

    //! Renvoie le vector des entités de la table des entités Ent vérifiant la condition,
    //! valeur de la colonne d'identifiant cle = value, ordonnée suivant la colonne d'identifiant ordre.
    template<class Ent> VectorPtr<Ent> getVector(typename Ent::Position cle, const QVariant & value,
                                                 typename Ent::Position ordre = Ent::Id,
                                                 bdd::Condition cond = bdd::Condition::Egal, bool crois = true);

    //! Renvoie le vector des entités de la table des entités Ent vérifiant la condition,
    //! valeur de la colonne d'identifiant cle = value, ordonnée suivant les colonnes d'identifiant ordre1 puis ordre2.
    template<class Ent> VectorPtr<Ent> getVector(typename Ent::Position cle, const QVariant & value, typename Ent::Position ordre1,
                                                 typename Ent::Position ordre2, bdd::Condition cond = bdd::Condition::Egal,
                                                 bool crois1 = true, bool crois2 = true);
    ...
    //! Renvoie le vecteur des entités de la table vérifiant les conditions, pour tout i,
    //! valeur de la colonne d'identifiant cle[i] condition[i] value[i],
    //! ordonnée suivant les colonnes d'identifiant contenue dans ordre, croissante (crois[i]=true) ou décroissante (croiss[i]=false).
    template<class Ent> VectorPtr<Ent> getVector(QList<typename Ent::Position> cle, QList<const QVariant> & value,
                         QList<typename Ent::Position> ordre = QList<typename Ent::Position>(),
                         QList<bdd::Condition> condition = QList<bdd::Condition>(), QList<bool> crois = QList<bool>());
    ...
    //! valeur de la colonne de la jointure d'identifiant cleWhere = valueWhere,
    //! ordonnée suivant la colonne de l'entité d'identifiant ordre.
    template<class Ent, class Join> VectorPtr<Ent> getVector(typename Join::Position cleJoin, typename Join::Position cleWhere,
                                                             const QVariant & valueWhere, typename Ent::Position ordre = Ent::Id,
                                                             bdd::Condition cond = bdd::Condition::Egal, bool crois = true);
...
template<class Ent> bool Bdd::exists(typename Ent::Position cle, const QVariant & value, bdd::Condition cond)
...
template<class Ent> bdd::ExisteUni Bdd::existsUniqueEnsemble(Ent & entity)
...
template<class Ent, class T> T Bdd::fonctionAgrega(bdd::Agrega fonc, typename Ent::Position att, typename Ent::Position cle,
                                                   const QVariant & value, bdd::Condition cond)
...
template<class Ent> bool Bdd::getAutorisation(const Ent & entity, bdd::Autorisation autorisation)
...
template<class Ent> ListPtr<Ent> Bdd::getList(typename Ent::Position cle, const QVariant & value,
...
template<class Ent> ListPtr<Ent> Bdd::getList(typename Ent::Position cle, const QVariant & value,
                                              typename Ent::Position order1, typename Ent::Position order2,
                                              typename Ent::Position ordre3, bdd::Condition cond,
...
template<class Ent> ListPtr<Ent> Bdd::getList(typename Ent::Position cle1, const QVariant & value1,
                                              typename Ent::Position cle2, const QVariant & value2,
                                              typename Ent::Position order, bdd::Condition cond1, bdd::Condition cond2, bool croissant)
...
template<class Ent> ListPtr<Ent> Bdd::getList(typename Ent::Position cle1, const QVariant & value1,
                                              ...
                                              bdd::Condition cond1, bdd::Condition cond2, bdd::Condition cond3, bool croissant)
    {return m_manager->get<Ent>()->getList(cle1, value1, cle2, value2, cle3, value3, order, cond1, cond2, cond3, croissant);}

template<class Ent> ListPtr<Ent> Bdd::getList(const QList<typename Ent::Position> &cle, const QList<QVariant> &value,
                     const QList<typename Ent::Position> &ordre,
                     const QList<bdd::Condition> &condition, const QList<bool> &crois)
    {return m_manager->get<Ent>()->getList(cle,value,ordre,condition,crois);}

template<class Ent, class Join> ListPtr<Ent> Bdd::getList(typename Ent::Position colonneTable, typename Join::Position colonneJoin,
...
template<class Ent, class Join> ListPtr<Ent> Bdd::getList(typename Join::Position cleJoin, typename Join::Position cleWhere,
...
template<class Ent> MapPtr<Ent> Bdd::getMap(typename Ent::Position cle, const QVariant & value,
                                            typename Ent::Position cleMap, bdd::Condition cond)
    {return m_manager->get<Ent>()->getMap(cle, value, cleMap, cond);}

template<class Ent> MapPtr<Ent> Bdd::getMap(typename Ent::Position cle1, const QVariant & value1,
                                            typename Ent::Position cle2, const QVariant & value2,
                                            typename Ent::Position cleMap, bdd::Condition cond1, bdd::Condition cond2)
...
template<class Ent> MapPtr<Ent> Bdd::getMap(QList<typename Ent::Position> cle, QList<const QVariant> & value,
                     typename Ent::Position cleMap,
                     QList<typename Ent::Position> ordre,
                     QList<bdd::Condition> condition, QList<bool> crois)
    {return m_manager->get<Ent>()->getMap(cle,value,cleMap,ordre,condition,crois);}
template<class Ent, class Join> MapPtr<Ent> Bdd::getMap(typename Ent::Position colonneTable, typename Join::Position colonneJoin,
                                               const QMap<int,QVariant> & whereMapTable, const QMap<int,QVariant> & whereMapJoin,
                                               typename Ent::Position cleMap)
{
    QMap<QString,QVariant> whereMapJoinString;
...
template<class Ent, class Join> MapPtr<Ent> Bdd::getMap(typename Join::Position cleJoin,
...
template<class Ent> QList<int> Bdd::getRestriction(const Ent & entity)
...
template<class Ent> VectorPtr<Ent> Bdd::getVector(typename Ent::Position ordre, bool croissant)
    {return VectorPtr<Ent>(m_manager->get<Ent>()->getList(ordre, croissant));}

template<class Ent> VectorPtr<Ent> Bdd::getVector(typename Ent::Position cle, int value,
                                                  typename Ent::Position ordre, bdd::Condition cond, bool crois)
    {return VectorPtr<Ent>(m_manager->get<Ent>()->getList(cle, value, ordre, cond, crois));}

template<class Ent> VectorPtr<Ent> Bdd::getVector(typename Ent::Position cle, const QVariant & value,
                                                  typename Ent::Position ordre, bdd::Condition cond, bool crois)
    {return VectorPtr<Ent>(m_manager->get<Ent>()->getList(cle, value, ordre, cond, crois));}

template<class Ent> VectorPtr<Ent> Bdd::getVector(typename Ent::Position cle, const QVariant & value,
                                                  typename Ent::Position ordre1, typename Ent::Position ordre2,
                                                  bdd::Condition cond, bool crois1, bool crois2)
    {return VectorPtr<Ent>(m_manager->get<Ent>()->getList(cle, value, ordre1, ordre2, cond, crois1, crois2));}

template<class Ent> VectorPtr<Ent> Bdd::getVector(typename Ent::Position cle, const QVariant & value,
                                                  typename Ent::Position ordre1, typename Ent::Position ordre2,
                                                  typename Ent::Position ordre3,
...
template<class Ent> VectorPtr<Ent> Bdd::getVector(typename Ent::Position cle1, const QVariant & value1,
                                                  typename Ent::Position cle2, const QVariant & value2,
                                                  typename Ent::Position order, bdd::Condition cond1, bdd::Condition cond2,
                                                  bool croissant)
...
template<class Ent> VectorPtr<Ent> Bdd::getVector(typename Ent::Position cle1, const QVariant & value1,
                                                  typename Ent::Position cle2, const QVariant & value2,
                                                  typename Ent::Position cle3, const QVariant & value3,
                                                  typename Ent::Position order, bdd::Condition cond1,
                                                  bdd::Condition cond2, bdd::Condition cond3, bool croissant)
    {return VectorPtr<Ent>(m_manager->get<Ent>()->getList(cle1, value1, cle2, value2, cle3, value3, order, cond1, cond2, cond3, croissant));}

template<class Ent> VectorPtr<Ent> Bdd::getVector(QList<typename Ent::Position> cle, QList<const QVariant> & value,
                     QList<typename Ent::Position> ordre,
                     QList<bdd::Condition> condition, QList<bool> crois)
    {return VectorPtr<Ent>(m_manager->get<Ent>()->getList(cle,value,ordre,condition,crois));}

template<class Ent, class Join> VectorPtr<Ent> Bdd::getVector(typename Ent::Position colonneTable, typename Join::Position colonneJoin,
                                               const QMap<int,QVariant> & whereMapTable, const QMap<int,QVariant> & whereMapJoin,
                                               const QList<QPair<int, bool> > &orderMapTable)
{
    QMap<QString,QVariant> whereMapJoinString;
...
template<class Ent, class Join> VectorPtr<Ent> Bdd::getVector(typename Join::Position cleJoin, typename Join::Position cleWhere,
                                                              const QVariant & valueWhere, typename Ent::Position ordre,
                                                              bdd::Condition cond, bool crois)
...
template<class Ent> VectorPtr<Ent> Bdd::getVectorChilds(const Ent & entity)
...
template<class Ent> void Bdd::save(Ent & entity, bdd::Autorisation autorisation, bool bb)
    {m_manager->get<Ent>()->save(entity, autorisation, bb);}

template<class Ent> void Bdd::save(const Ent & entity, bdd::Autorisation autorisation, bool bb)
    {m_manager->get<Ent>()->save(entity, autorisation, bb);}

template<class Ent> void Bdd::save(Ent & entity, const QMap<bdd::Autorisation,bool> & autorisations)
    {m_manager->get<Ent>()->save(entity, autorisations);}

template<class Ent> void Bdd::save(const Ent & entity, const QMap<bdd::Autorisation,bool> & autorisations)
    {m_manager->get<Ent>()->save(entity, autorisations);}

template<class Ent> void Bdd::save(Ent & entity, const QList<bdd::Autorisation> restriction)
    {m_manager->get<Ent>()->save(entity, restriction);}

template<class Ent> void Bdd::save(const Ent & entity, const QList<bdd::Autorisation> restriction)
    {m_manager->get<Ent>()->save(entity, restriction);}
...
template<class Ent> void Bdd::save(Tree<Ent> & arbre, bdd::TreeSave n)
    {m_manager->get<Ent>()->save(arbre,n);}

template<class Ent> void Bdd::setAutorisation(const Ent & entity, bdd::Autorisation autorisation, bool bb)
    {m_manager->get<Ent>()->setAutorisation(entity, autorisation, bb);}

template<class Ent> void Bdd::setAutorisation(const Ent & entity, const QMap<bdd::Autorisation,bool> & autorisations)
    {m_manager->get<Ent>()->setAutorisation(entity, autorisations);}

template<class Ent> void Bdd::setRestriction(const Ent & entity, const QList<bdd::Autorisation> restriction)
    {m_manager->get<Ent>()->setRestriction(entity, restriction);}

template<class Ent> void Bdd::setRestriction(const Tree<Ent> & tree, const QList<bdd::Autorisation> restriction)
{
