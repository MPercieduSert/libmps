...
SelectDonneeDialog::SelectDonneeDialog(const conteneurMPS::tree<Donnee> &tree, QWidget *parent)
    : QDialog(parent) {
    ...
    m_treeWidget = new widgetMPS::ReadTreeWidget<Donnee>(tree, {Donnee::Position::Nom,Donnee::Position::TpVal});
