...
public:
    ...
    protected: 
       ...
       std::vector<double> m_xGraduation;   //!< Liste des graduations l'axe des abscisses.
       std::vector<double> m_yGraduation;   //!< Liste des graduations de l'axe des ordonées.
    ...
    public:      //! Constructeur.
        ...
        const std::vector<double> & xGraduation() const
        ...
        szt xNumGraduation() const
            {return m_xGraduation.size();}
        ...
        const std::vector<double> & yGraduation() const
        ...
        szt yNumGraduation() const
            {return m_yGraduation.size();}
        ...
        //! Mutateur de xGrduation.
        void setXGraduation(const std::vector<double> valeur) {
        ...
        //! Mutateur de xGrduation.
        void setYGraduation(const std::vector<double> valeur) {
