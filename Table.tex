...
\matrix[ampersand replacement=\&,column sep =1cm, row sep =0.5cm]{
	...
	\tableEntity{Style}{
		bordure&int&int&bd\\
		couleurFond&color&color&cf\\
		couleurTexte&color&color&cte\\
		couleurTitre&color&color&cti\\
		fond&brush&brush&fd\\
		forme&int&int&fm\\
		nom&text&stringNotEmpty&nm\\
		policeTexte&font&font&pte\\
		policeTitre&font&font&pti
	}{
		\unique{nom}
	}
	\\
