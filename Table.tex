...
\scriptsize
	...
	}[right=1.2cm of TypeEtablissement,\bdd]
	...
	}[right=1.2cm of NiveauTypeEtablissament,\bdd]
	...
	\tableEntity{Etablissement}{
		...
		\fkey{idTpEtab}{TypeEtablissement}\\
		\unique{nom}
	}[below=0.2cm of TypeEtablissement,\bdd]
	...
	}[right=.8cm of Etablissement,\bdd]
	...
	\tableEntity{Niveau}{
		...
		\fkey{type}{Type}\\
		\unique{nom}	
	}[below=0.5cm of FiliationNiveau,\bdd]

	\tableEntity{Annee}{
		num&int&intSup0&num
	}{
		\unique{num}
	}[below=0.15cm of Etablissement,\bdd]
	...
	}[below=0.5cm of ClasseEleve,\bdd]
	...
	}[below=2.25cm of ControleEpreuve,\bdd]
