...
\begin{tikzpicture}[thick]
\footnotesize
\matrix[ampersand replacement=\&,column sep =0.25cm, row sep =0.7cm]{
	\arbreTable{Usage}
	\&
	\tableEntity{Usage}{
		nc&text&stringNotEmpty&nc\\
...
\footnotesize
	...
	\relation{obtenue}[below=0.75cm of Eleve]
	
	\relationWithAttributs{dansControle}{numGroupe\\version}[right=1cm of Controle]
	...
	\entity{Point}{
		...
		valeur\\
		version
	}[left=1.5cm of valide]
	
	\relation{priseEnCompte}[below=3cm of Point]
	
	\relationWithAttributs{ventile}{
		num\\
		numEpreuve}[left=1.5cm of Point]
	
	\arbreERD{Enonce}[below=5.5cm of ventile]
	
	\entity{Enonce}{
		type\\
		version
	}[left=3cm of filiationEnonce]
	
	
	\arbreERD{Bareme}[below=6.55cm of valide]
	
	\entity{Bareme}{type\\valeur}[below=3cm of priseEnCompte]
	
	\relation{sommetSujet}[above=2.5cm of Enonce]

	\relation{sommetBareme}[left=9.5cm of Bareme]
	
	\entity{Epreuve}{version}[above=5cm of sommetBareme]
...
\scriptsize
	...
	\tableEntity{NiveauTypeEtablissament}{
	...
	}[right=1.2cm of TypeEtablissement]
	...
	}[right=1.2cm of NiveauTypeEtablissament]
	...
	\tableEntity{ClasseEleve}{
		...
		sortie&dateTime&dtValide&sort&NULL
	}{
	...
	\tableEntity{Enonce}{
		...
		\fkey{id}{ArbreEnonce}
	}[below=0.4cm of ControleEnonce]

	\tableEntity{Bareme}{
		idPoint&uint&idSup1&idPt&NULL\\
		type&uint&idSup1&tp\\
...
\lkey{TypeEtablissement}{NiveauTypeEtablissament}
...
\lkey{Niveau.north west}{NiveauTypeEtablissament}
...
\lkey{Eleve}{Note}
\lkey{Classe.south east}{ControleEnonce.north east} 
\lkey{Groupe}{ControleEnonce}
\lkey{Eleve}{ControleEnonce.north east} 
\lkey{Controle.north east}{ControleEnonce.south west} 
\lkey{Enonce}{ControleEnonce} 
\lkey{Note}{Valide}
\lkey{TypeControle}{Controle}
\lkey{Point}{Valide}
\lkeyloop{TypeControle}
\lkey{Enonce}{Point.north west}
\lkey{Point}{Bareme}
