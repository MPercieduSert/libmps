...
\subsubsection{ERD}
	...
	\lien{ciblageProg}{CibleMotCleProg}{$1$}
	\lien{MotCle}{controleProg}{$0-N$}
	\lien{controleProg}{PermissionMotCleProg}{$1$}  
	\end{tikzpicture}
	
	\subsubsection{Tables}
	\begin{tikzpicture}[thick]
	\matrix[ampersand replacement=\&,column sep =.25cm, row sep =0.25cm]{
		\tableEntity{PermissionMotCleProg}{
			idMotCle& uint &idSup1& idMC &\\
			cible&int&int&cb&\\
			code& uint &code& cd \\
			idProg&uint&unsigned&idPg
		}{
			\fkey{idMotCle}{MotCle}\\
			\unique{idMotCle, cible, idProg}
		}
		\&
		\arbreTable{MotCle}	
		\&
	...
	\lkey{MotCle}{CibleMotCleProg}
	\lkey{MotCle}{PermissionMotCleProg}  
	\end{tikzpicture}
...
\footnotesize
	...
	}[right=.8cm of TypeEtablissement]
	...
	}[right=.8cm of NiveauTypeEtablissament]
