...
// */
//class Tabmot_cle : public abstract_tabModuleWithBdd {
//    Q_OBJECT
//protected:
...
//public:
//    //! Constructeur.
//    explicit Tabmot_cle(bmps::BddPredef &bdd, const tab_index &index, QWidget *parent = nullptr);
...
//        {return static_cast<bmps::BddPredef &>(abstract_tabModuleWithBdd::bdd());}
