...
public:
    ...
    FenFoundFile(fimps::file_interface &file, QWidget *modal = nullptr, QObject *parent = nullptr)
...
protected:
     ...
     */
    QString foundFileMessage(const QString &text, const QString &name, const QString &extension,
